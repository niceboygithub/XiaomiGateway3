...
DEVICES_AIOT_GATEWAY = [{
    ...
    "lumi.gateway.agl011": ["Aqara", "Hub M200 CN", "AG047GLB02"],
    "spec": [
        MapConv("pair", mi="8.0.2109", map={60: True, 0: False}),
...
DEVICES_AIOT_ZIGBEE = [{
    ...
    "spec": [
        ...
        BaseConv("action", "sensor"),
        # other sensors
        BaseConv("li_battery", "sensor", mi="13.32.85", entity={"class": "battery", "units": "%", "category": "diagnostic"}),
        MathConv("li_battery_temperature", "sensor", mi="13.33.85", multiply=0.1, round=1, entity={"class": "temperature", "units": UNIT_CELSIUS, "category": "diagnostic"}),
    ...
    "params": [
        ...
        # other sensors
        MathConv("voltage", "sensor", mi="13.55.85", multiply=0.001, round=2),
        BaseConv("li_battery", "sensor", mi="13.56.85", entity={"class": "battery", "units": "%", "category": "diagnostic"}),
        MathConv("li_battery_temperature", "sensor", mi="13.69.85", multiply=0.1, round=1, entity={"class": "temperature", "units": UNIT_CELSIUS, "category": "diagnostic"}),
    ],
    "ttl": "0s",
}, {
